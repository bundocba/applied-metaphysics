...
<form method="post" action="<?php echo JRoute::_('index.php?option=com_rsmail&view=reports&layout=links'); ?>" name="adminForm" id="adminForm">
	<div class="row-fluid">
		<div class="span2">
			...
			<table class="table table-striped adminlist">
				<thead>
					<tr>
						...
						<th><?php echo JText::_('RSM_LINK'); ?></th>
