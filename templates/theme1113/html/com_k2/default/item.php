...
<!-- Date created -->
		<?php if($this->item->params->get('itemDateCreated')): ?>
			<span class="itemDateCreated">
				...
				<span class="day"><?php echo JHTML::_('date', $this->item->created , JText::_('K2_DATE_FORMAT_LC8')); ?></span>
			</span>
		<?php endif; ?>
		...
		<?php if($this->item->params->get('itemImage') && !empty($this->item->image)): ?>
			<div class="itemImageBlock">
				<span class="itemImage">
					...
					<?php else: ?>
						<a class="modal img" rel="{handler: 'image'}" href="<?php echo $this->item->imageXLarge; ?>" title="<?php echo JText::_('K2_CLICK_TO_PREVIEW_IMAGE'); ?>">
								<img src="<?php echo $this->item->image; ?>" alt="<?php if(!empty($this->item->image_caption)) echo K2HelperUtilities::cleanHtml($this->item->image_caption); else echo K2HelperUtilities::cleanHtml($this->item->title); ?>" style="width:<?php echo $this->item->imageWidth; ?>px; height:auto;" />
...
<!-- Item Social Buttons -->
				<?php if($this->item->params->get('itemSocialButton') && !is_null($this->item->params->get('socialButtonCode', NULL))): ?>
					<div class="social-button">
						<span class="label"><?php echo JText::_('K2_SOCIAL_BOOKMARKS'); ?></span>
