...
<div class="catItemView blog group<?php echo ucfirst($this->item->itemGroup); ?><?php /*echo ($this->item->featured) ? ' catItemIsFeatured' : '';*/ ?><?php if($this->item->params->get('pageclass_sfx')) echo ' '.$this->item->params->get('pageclass_sfx'); ?>">
...
<!-- Date created -->
		<?php if($this->item->params->get('catItemDateCreated')): ?>
			<span class="catItemDateCreated">
				<?php echo JText::_('TPL_ON'); ?>
				<?php echo JHTML::_('date', $this->item->created , JText::_('K2_DATE_FORMAT_LC8')); ?>
			</span>
		<?php endif; ?>
