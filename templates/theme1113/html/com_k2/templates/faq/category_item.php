...
<div id="faqs" class="catItemView group<?php echo ucfirst($this->item->itemGroup); ?><?php /*echo ($this->item->featured) ? ' catItemIsFeatured' : '';*/ ?><?php if($this->item->params->get('pageclass_sfx')) echo ' '.$this->item->params->get('pageclass_sfx'); ?>">
	...
	<div class="catItemHeader">
	  ...
	  <span class="ques"><?php echo JText::_('K2_QES'); ?></span>
...
<dd class="answer">
  <div class="catItemBody">
	  ...
	  <!-- Item introtext -->
		...
		<span class="ans"><?php echo JText::_('K2_ANS'); ?></span>
