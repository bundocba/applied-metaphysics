  ...
  <div class="catItemBody">
	  ...
	  <div class="catItemImageBlock">
		  <span class="catItemImage">
		    <a rel="{handler: 'image'}" class="modal img" href="<?php echo $this->item->imageXLarge; ?>" title="<?php if(!empty($this->item->image_caption)) echo $this->item->image_caption; else echo $this->item->title; ?>">
                ...
                <span class="zoom-text"><?php echo JText::_('K2_ZOOM'); ?></span>
		    </a>
		  </span>
		  <div class="clr"></div>
	  </div>
	  		...
	  		<div class="catItemHeader">
				...
				<?php if($this->item->params->get('catItemTitle')): ?>
					...
					<h3 class="catItemTitle">
						...
						<?php echo $substr_title = substr($this->item->title, 0); ?>
						</a>
						<?php else: ?>
				...
				<span class="catItemDateCreated">
					<?php echo JHTML::_('date', $this->item->created , JText::_('d l, Y')); ?>
				</span>
				<?php endif; ?>
				...
				<?php echo substr($this->item->introtext, 0); ?>
				</div>
				<?php endif; ?>
